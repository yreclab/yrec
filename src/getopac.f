...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      ...
      use settings, only : OPTOL  ! /OPTAB/
      use settings, only : ZLAOL1, ZLAOL2, ZOPAL1, ZOPAL2, ZKUR1, ZKUR2, TMOLMIN, TMOLMAX,
     +                     LALEX06, LLAOL89, LOPAL92, LOPAL95, LKUR90, LALEX95, L2Z  ! /NEWOPAC/
      use settings, only : LcondOpacP  ! /MISCOPAC/
