...
C KC 2025-04-22 Downgraded this to arrays as it was only used in bsrotmix.f.
C      COMMON/BSBURN/HCOMPI(11,15,JSON),HCOMPA(15,JSON),HCOMPE(15,JSON)
      DIMENSION HCOMPI(11,15,JSON),HCOMPA(15,JSON),HCOMPE(15,JSON)
