...
C       DIMENSION HCOMP(17,JSON),HR(JSON),HP(JSON),HD(JSON),HG(JSON),HS1(JSON),  ! KC 2025-05-31
      DIMENSION HCOMP(17,JSON),HR(JSON),HP(JSON),HD(JSON),HS1(JSON),
     *      HT(JSON),FP(JSON),FT(JSON),HCOMPF(17,JSON),HRF(JSON),HPF(JSON),
