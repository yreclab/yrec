...
C G Somers 3/17, ADDING NEW TAUCZ COMMON BLOCK
      ...
      DIMENSION FXION(3),TLUMX(8),HCOMP(17,JSON),HD(JSON),HL(JSON),
...
C JVS 02/12 Added PPHOT and SMASS to the output
     ...
     *      ENVR,ENVT,ENVD,ENVP,ENVO,TL,DL,PL,BETA,ETA,HCOMP(1,1),HCOMP(2,1),
     ...
     3      (HCOMP(I,M),I=4,17),(HCOMP(I,M),I=1,3),HCOMP(3,M)/HCOMP(1,M),
...
C MCR 12/25 Preserve precision and 'E' for values w/ 3-digit exponents
 1499       FORMAT(1X,2I8,1P7E17.8E3,1P5E12.4,18E17.8E3,12E10.3,41E17.8E3)
...
C ADD SURFACE X,Y,Z,Z/X.
            WRITE(ITRACK,1520)(HCOMP(I,M),I=4,17),
     *        (HCOMP(I,M),I=1,3),HCOMP(3,M)/HCOMP(1,M)
 1520       FORMAT(1X,1P8E16.8,/,1X,1P8E16.8,/,1X,1P2E16.8)
C ROTATION I/O
            IF(LROT) THEN
