...
C       WRITE(*,202) FSPOT
C202    FORMAT("FSPOT ",1P1E12.3)



C JVS 02/12 Added PPHOT and SMASS to the output
C A Ash 9/8 Added Fspot to output 
     ...
     *      ENVR,ENVT,ENVD,ENVP,ENVO,TL,DL,PL,BETA,ETA,HCOMP(1,1),HCOMP(2,1),
     ...
     4      SJTOT,SKEROT,HITOT,HICZ,OMEGA(M),OMEGA(1),ROTP,ROTV,TAUCZ, FSPOT,
...
1499       FORMAT(1X,2I8,1P7E16.8,1P5E12.4,16E16.8,12E10.3,42E16.8)
...
C 4/09 ADDED TAUCZ TO ROTATION INFORMATION
         IF (ITRVER .EQ. 2) THEN
C           CALL GETTAU(HCOMP,HR,HP,HD,HS1,HT,FP,FT,TEFFL,HSTOT,BL,M,LC,ENVR)
C            TAUCZ0 = TAUCZ

C            CALL GETSPOT(M)
          WRITE(*,209) FSPOT
209       FORMAT("FSPOT ",1P1E12.3)
            WRITE(ITRACK,1540)SJTOT,SKEROT,HITOT,HICZ,OMEGA(M),
     *                     OMEGA(1),ROTP,ROTV,TAUCZ, FSPOT
 1540       FORMAT(1X, 1P6E13.5,0P,2F11.5,2E13.5)
         END IF
         IF (ITRVER .EQ. 3) THEN
...
C      *            LPRT, TEFFL, HCOMP, NKK, DAGE, DDAGE, JENV)  ! KC 2025-05-31
     ...
     *      ENVR,ENVT,ENVD,ENVP,ENVO,TL,DL,PL,BETA,ETA,HCOMP(1,1),HCOMP(2,1),
     ...
     2      CLSNU,GASNU,(FLUXTOT(I),I=1,10),(HCOMP(I,1),I=4,11),
     3      (HCOMP(I,M),I=4,15),(HCOMP(I,M),I=1,3),HCOMP(3,M)/HCOMP(1,M),
     4      SJTOT,TAUCZN,TCZ,TNORM,TAUHE,WHE,TATMOS,ROTV,TAUCZ,FSPOT,
