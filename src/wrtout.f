...
C$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
     ...
     * FP,FT,ETA2,R0,HJM,HI,SJTOT,SKEROT,HS2,NKK)
      ...
      use parmin90, only : ISCOMP  ! COMMON/LUNUM/
      use parmin90, only : FSCOMP  ! COMMON/LUFNM/
      use parmin90, only : ILAST, ITRACK, ISHORT, ISTOR  ! COMMON/LUOUT/
      use parmin90, only : CLSUN, CLSUNL, CMSUN, CRSUN, CRSUNL, CMBOL  ! COMMON/CONST/
      use parmin90, only : CLN, C4PI, C4PIL, C4PI3L, CC13, CC23  ! COMMON/CONST1/
