...
C     * FP,FT,ETA2,R0,HJM,HI,SJTOT,SKEROT,HS2,TAUCZ)
      PARAMETER (JSON=5000)
...
C                CALL GETSPOT(HCOMP,HR,HP,HD,HS1,HT,FP,FT,TEFFL,HSTOT,BL,M,LC,RBCZ, OMEGA, TAUCZ)
                CALL GETSPOT(HCOMP,HR,HP,HD,HS1,HT,FP,FT,TEFFL,HSTOT,BL,M,LC,RBCZ, OMEGA)
...
C       CALL GETTAU(HCOMP,HR,HP,HD,HG,HS1,HT,FP,FT,TEFFL,  ! KC 2025-05-31
     ...
     *            HSTOT,BL,M,LC,ENVR,OMEGA, TAUCZ)
      TAUCZ0 = TAUCZ
      PPHOT0 = PPHOT
...
C JVS 02/12 Added PPHOT and SMASS to the output
     ...
     *      ENVR,ENVT,ENVD,ENVP,ENVO,TL,DL,PL,BETA,ETA,HCOMP(1,1),HCOMP(2,1),
     ...
     4      SJTOT,SKEROT,HITOT,HICZ,OMEGA(M),OMEGA(1),ROTP,ROTV,TAUCZ,SPOTF,
...
C     1499       FORMAT(1X,2I8,1P7E16.8,0PF8.4,1P4E12.4,16E16.8,12E10.3,41E16.8)
 1499       FORMAT(1X,2I8,1P7E16.8,1P5E12.4,16E16.8,13E10.3,41E16.8)
...
C
     ...
     *   HSTOT,DAGE,DDAGE,OMEGA,HS1,ETA2,R0,FP,FT,HJM,HI,TAUCZ)
       LPUNCH = .FALSE.
      ENDIF
...
C      *            LPRT, TEFFL, HCOMP, NKK, DAGE, DDAGE, JENV, OMEGA)  ! KC 2025-05-31
     *            TEFFL, HCOMP, DAGE, JENV,TAUCZ)
...
C solutions.
     ...
     *          FP,FT,TEFFL,HSTOT,BL,M,LC,MODEL, TAUCZ)
      ENDIF
