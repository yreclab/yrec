...
C MHP 6/98
     ...
     * TOL_DX_MAX, TOL_DZ_MAX, TIME_MAX_DT_FRAC, LNEWVARS  ! /NEWPARAM/
      ...
      use settings, only : DMDT0, FCZDMDT, FTOTDMDT, COMPACC, CREIM, LREIMER, LMDOT  ! /MASSCHG/
      use settings, only : LSOLWIND  ! /MASSCHG3/
      use settings, only : CSTMIXING, CSTDIFFMIX  ! /CMIXING/
      use mmodel, only : ICLCD, LCLCD, AGEOUT, IACAT, IJLAST, LJLAST, LJWRT, IJVS, IJENT, IJDEL, LACOUT  ! /ACDPTH/
