...
C JNT 09/2025 FOR 05/15 IMPJMOD default set to 0
     ...
     *     1.696d-5,0.0d0,2.0d-9,2.0d-9,3.0d-11,1.0d-9,5.0d-9,-4.0D-13,
     *     .FALSE.,.FALSE./
...
C           DEFAULT BE9(P,A)LI6 (BE93) = 15,000 keV b FROM FOWLER ET AL. 1967
      DATA XSLI6, XSLI7, XSBE91, XSBE92, XSBE93, XSB101, XSB102, XSB111, XSB112
     *     /5.5D3, 5.2D1, 1.1D0, 1.5D4, 1.5D4, 1.0D0, 1.0D0, 1.0D0, 1.0D0/
      DATA LXLI6, LXLI7, LXBE91, LXBE92, LXBE93, LXB101, LXB102, LXB111, LXB112,
     *     SLI6, SLI7, SBE91, SBE92, SBE93, SB101, SB102, SB111, SB112
...
C     PASSED ALL CHECKS - EITHER THE DEFAULT OR THE CUSTOM SETTINGS WILL BE APPLIED
 ...
 605     FORMAT('ISOTOPE AND LIGHT ELEMENT MIXTURE ',A8,' C12/C13 ',
     ...
     *   E12.4,' LI7 ',E12.4,' BE9 ',E12.4,' B10 ',E12.4,' B11 ',
     *   E12.4,' APPLIED TO STARTING MODEL.')
      ENDIF
