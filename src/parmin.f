...
C$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
      ...
      use parmin90, only : VNEW  ! COMMON/VNEWCB/
      use parmin90, only : ILAST, IDEBUG, ITRACK, ISHORT,
     1    IMILNE, IMODPT, ISTOR, IOWR  ! COMMON/LUOUT/
      use parmin90, only : IFIRST, IRUN, ISTAND, IFERMI,
     1    IOPMOD, IOPENV, IOPATM, IDYN,
     2    ILLDAT, ISNU, ISCOMP, IKUR  ! COMMON/LUNUM/
      use parmin90, only : FLAST, FFIRST, FFERMI,
...
C KC 2025-04-22 Downgraded this to array as it was only used in parmin.f.
C      COMMON/DESC/DESCRIP
