...
C LMB 5/2026 ADD NTM AND NGM FOR MARCS SURFACE PRESSURES
...
C JNT 6/14 SAME AS ATMOS2 BUT FOR KURUCZ/CASTELLI2004 ATMOSPHERES
     ...
     *              ATMGLC(NGC)
C LMB 5/26 SAME AS ATMOS2 BUT FOR MARCS ATMOSPHERES
...
C JNT 6/14 ADD FOR NEW KURUCZ/CASTELLI ATMOSPHERE TABLES
      ELSE IF (KTTAU .EQ. 5) THEN
           WRITE(ISHORT, 1887)
C LMB 5/26 ADD FOR NEW MARCS ATMOSPHERE TABLES
 ...
 1886 FORMAT(' USING MARCS ATMOSPHERE TABLE')
