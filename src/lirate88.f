...
C G Somers 6/14, IMPORT LIGHT ELEMENT SCALE FACTOR BLOCK
      COMMON/BURNSCS/SLI6,SLI7,SBE91,SBE92,SBE93,SB101,SB102,SB111,SB112
C G Somers END
      DIMENSION HCOMP(17,JSON),HD(JSON),HT(JSON)
      DATA TLIM/6.0D0/
      SAVE
...
C LC 4/26, Add B10, B11:
C
C B10(P,GAMMA)C11 (B10PG)
C
         FB101=4.61D+05/T923*EXP(-12.062/T913-(T9/4.402)**2)
     1   *(1.0D0+0.035*T913+0.426*T923+0.103*T9+0.281*T943+0.173*T953)
     2   +1.93D+05/T932*EXP(-12.041/T9)+1.14D+04/T932*EXP(-16.164/T9)
C
C B10(P,ALPHA)BE7 (B10PA)
C
         FB102=1.26D+11/T923*EXP(-12.062/T913-(T9/4.402)**2)
     1   *(1.0D0+0.035*T913-0.498*T923-0.121*T9+0.300*T943+0.184*T953)
     2   +2.59D+09/T9*EXP(-12.260/T9)
C
C B11(P,GAMMA)C12 (B11PG)
C
         FB111=4.62D+07/T923*EXP(-12.095/T913-(T9/0.239)**2)
     1   *(1.0D0+0.035*T913+3.00*T923+0.723*T9+9.91*T943+6.07*T953)
     2   +7.89D+03/T932*EXP(-1.733/T9)+9.68D+04/T915*EXP(-5.617/T9)
C
C B11(P,ALPHA)2HE4 (B11PA)
C
         FB112=2.20D+12/T923*EXP(-12.095/T913-(T9/1.644)**2)
     1   *(1.0D0+0.034*T913+0.140*T923+0.034*T9+0.190*T943+0.116*T953)
     2   +4.03D+06/T932*EXP(-1.734/T9)+6.73D+09/T932*EXP(-6.262/T9)
     3   +3.88D+09/T9*EXP(-14.154/T9)
C
