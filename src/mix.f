...
C CONTAIN NEUTRINO FLUXES FOR SOLAR NEUTRINO CALCULATIONS.
     ...
     *     MXZONE,MXZON0,TEFFL)
      ...
      use settings, only : DPENV, LSEMIC  ! /DPMIX/
      use settings, only : LEXCOM  ! /FLAG/
      use settings, only : DT_GS, XMIN, YMIN  ! /GRAVS2/
      use settings, only : LNEWDIF  ! /GRAVS4/
      use settings, only : LDIFY  ! /GRAVST/
      use settings, only : DMDT0, COMPACC, LMDOT  ! /MASSCHG/
