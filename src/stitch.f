...
C PRESSURE AT THE AMBIENT TEMPERATURE ATEFFL
      CALL GETSPOT(M,TEFFL)
C      IF(LC(M).AND.SPOTF.NE.0.0.AND.SPOTX.NE.1.0)THEN
C      IF(SPOTF.NE.0.0.AND.SPOTX.NE.1.0)THEN 
...
C     &     F9.5,F9.5,E12.4,E12.4,E12.4,E12.4,E12.4,E13.5,E13.5,E13.5,E13.5)
     &  1X,F9.5,1X,F9.5,1X,F9.5,E12.4,E12.4,E12.4,E12.4,E12.4,E13.5,E13.5,E13.5,E13.5,E13.5,E13.5,E13.5,
     &  E13.5)
