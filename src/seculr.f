...
C      * HR(JSON),LC(JSON),OMEGA(JSON),HL(JSON),ETA2(JSON),QIW(JSON),  ! KC 2025-05-31
     ...
     * HV(JSON),QWLNR(JSON),HCOMP(17,JSON),
 ...
 198  FORMAT('COMPOSITION CHANGE FROM ROTATIONAL MIXING'/
     ...
     *       7X,'LI7',7X,'BE9')
      DO I = 1,IDM
         ...
         DB10 = HCOMP(16,ID(I))-HCOMPS(16,ID(I))
         DB11 = HCOMP(17,ID(I))-HCOMPS(17,ID(I))
         WRITE(IMODPT,199)ID(I),DX,DHE3,DC12,DC13,DN14,DLI7,DBE9,DB10,DB11
