...
C LC 2026: edited to add B10, B11.
      PARAMETER (NLIGHT=5)
...
C MHP 3/94 ADDED METAL DIFFUSION
      ...
      DIMENSION HCOMP(17,JSON),HQPR(JSON),HR(JSON),HS1(JSON),HT(JSON),
...
C     OF EACH SHOULD EQUAL NLIGHT.
      DATA CSLIGHT/13,14,15,16,17/
      DATA ASLIGHT/6.015D0,7.016D0,9.012D0,10.013D0,11.009D0/
      DATA ZSLIGHT/3.0D0,3.0D0,4.0D0,5.0D0,5.0D0/
      SAVE
